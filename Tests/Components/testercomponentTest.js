...
import testercomponent from '../../App/Components/testercomponent'

const wrapper = shallow(<testercomponent />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('testercomponent Component')) // That the Component Text is included
})
