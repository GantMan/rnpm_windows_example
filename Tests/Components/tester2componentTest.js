...
import tester2component from '../../App/Components/tester2component'

const wrapper = shallow(<tester2component />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('tester2component Component')) // That the Component Text is included
})
